/*
                ...
                output.println("Hva heter du?");
                input = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));

                String line = input.readLine();

                output.println("Hallo " + line);
                output.close();
        ...
        while (true) {
            while (true) {
                try {
                    ...
                    HttpRequestMethod requestMethod = HttpRequestMethod.fromString(requestMethodString);
                    if (requestMethod == HttpRequestMethod.UNKNOWN) {
